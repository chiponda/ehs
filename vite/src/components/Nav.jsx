...
<NavLink to="/incidents"> <ListItem className="flex items-center gap-2 py-2 pr-4">Incidents</ListItem></NavLink>
...
<NavLink to="/risks"> <ListItem className="flex items-center gap-2 py-2 pr-4">Risks/Hazards</ListItem></NavLink>
      ...
      <Typography
        ...
        color="blue-gray-900"
        className="font-medium"
      ><NavLink to="/AddIncidents"> <ListItem className="flex items-center gap-2 py-2 pr-4">
      Add Incident
    </ListItem></NavLink>
      ...
      <Typography
        ...
        color="blue-gray-900"
        className="font-medium"
      ><NavLink to="/AddRisks"> <ListItem className="flex items-center gap-2 py-2 pr-4">
      Add Risk/Hazard
    </ListItem></NavLink>
