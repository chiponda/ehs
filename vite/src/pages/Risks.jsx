...
export default function Risks() {
  ...
  const columns = useMemo(
    () => [
      ...
      {
        accessorFn: (data) => data.mitigation, //simple recommended way to define a column
      ...
      {
        accessorFn: (data) => data.created_at, //simple recommended way to define a column
        header: "Date Risk Recorded",
        muiTableHeadCellProps: STYLE, //custom props
        // eslint-disable-next-line react/prop-types
        Cell: ({ renderedCellValue }) => <strong>{renderedCellValue}</strong> //optional custom cell render
      },
